...
UI_REVISION = hashlib.sha256(b''.join((ROOT/'src'/name).read_bytes() for name in ('styles.css','experience.css','app.js','experience.js'))).hexdigest()[:12]
