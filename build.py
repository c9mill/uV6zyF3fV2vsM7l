...
for t,u in [('Спеціальності','/спеціальності/'),('Документи','/документи/'),('Контакти','/контакти/'),('Розклад занять',SCHEDULE),('Політика конфіденційності','/політика-конфіденційності/'),('Умови користування','/умови-користування/'),('Політика cookies','/політика-cookie/'),('Повернення коштів','/повернення-коштів/')]:SEARCH.append({'title':t,'url':u,'type':'Розділ','text':FULL_DISPLAY})
...
def privacy_policy():
    ...
    <h2>Хто відповідає за дані</h2><p>Володільцем персональних даних у межах роботи цього сайту є {FULL_DISPLAY}, адреса: 10029, Україна, м. Житомир, вул. Степана Бандери, 6. Запити щодо приватності: <a href="mailto:bkzt@ukr.net">bkzt@ukr.net</a>, телефон <a href="tel:+380412472847">(0412) 47-28-47</a>.</p>
