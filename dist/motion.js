...
(()=>{
  ...
  function setupMotion(){
    ...
    if(reduced.matches){showAll();resetPointer();clearScrollWave();hero?.style.removeProperty('--scroll-drift');return;}
  ...
  function clearMagnet(){if(magnet){magnet.style.removeProperty('--magnet-x');magnet.style.removeProperty('--magnet-y');magnet.classList.remove('motion-magnet');magnet=null;}}
