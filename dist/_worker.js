...
const TEACHERS = [
  ['17481', 'Берегова Валентина Петрівна'],
  ['247991', 'Березовська Наталія Василівна'],
  ['17513', 'Березовська Світлана Леонтіївна'],
  ['193659', 'Бічук Олег Ігорович'],
  ['17500', 'Бондарчук Тетяна Володимирівна'],
  ['247992', 'Булуй Олександр Григорович'],
  ['193658', 'Гошко Андрій Миколайович'],
  ['17504', 'Дорош Андрій Миколайович'],
  ['17483', 'Єлісєєва Алла Віталіївна'],
  ['17515', 'Заглада Олександр Михайлович'],
  ['17494', 'Каблов Анатолій Володимирович'],
  ['17511', 'Кирилюк Любов Петрівна'],
  ['17485', 'Коломієць Галина Іванівна'],
  ['17518', 'Кручко Сергій Петрович'],
  ['248432', 'Кумечко Константин Валентинович'],
  ['17520', 'Куратор'],
  ['17502', "Лук'янчук Юрій Васильович"],
  ['17517', 'Лукаш Наталія Богданівна'],
  ['17499', 'Маєвська Ганна Петрівна'],
  ['17490', 'Назарова Валентина Олександрівна'],
  ['17508', 'Наумчук Неля Василівна'],
  ['17489', 'Невмержицька Аліна Леонідівна'],
  ['17491', 'Олійник Наталія Василівна'],
  ['247990', 'Ольшанський Володимир Васильовач'],
  ['248452', 'Ольшанський Володимир Васильович'],
  ['17488', "П'ятківська Яна Петрівна"],
  ['17514', 'Палій Віталій Петрович'],
  ['194730', 'Палій Олена Григорівна'],
  ['17516', 'Підгородецький Олександр Васильович'],
  ['213676', 'Поліщук Віталій Валерійович'],
  ['17505', 'Полюх Віктор Миколайович'],
  ['17498', 'Прокопчук Лариса Володимирівна'],
  ['17503', 'Рибіцька Галина Володимирівна'],
  ['17509', 'Розенфельд Ірина Михайлівна'],
  ['17501', 'Рудейчук Тетяна Олександрівна'],
  ['247994', 'Семенчук Наталія Миколаївна'],
  ['247993', 'Сирокомська Світалана Миколаївна'],
  ['17497', 'Тамашевський Іван Якович'],
  ['247995', 'Тимошенко Олександр Олександрович'],
  ['194732', 'Тишкевич Тарас Леонідович'],
  ['194135', "Хом'як Володимир Анатолійович"],
  ['17506', "Хом'як Марія Сергіївна"],
  ['17510', 'Чепка Наталія Анатоліївна'],
  ['17512', 'Янчук Тетяна Петрівна']
].map(([id, name]) => ({id, name}));
...
async function catalog(ctx) {
  return cached('catalog-full-teachers', 300, async () => {
    const [students, teachers] = await Promise.all([source({obj_type:'44'}), source({obj_type:'14'})]);
    const [student, discoveredTeachers] = await Promise.all([readList(students, '44'), readList(teachers, '14')]);
    const teacher = [...new Map([...discoveredTeachers, ...TEACHERS].map(item => [item.id, item])).values()]
